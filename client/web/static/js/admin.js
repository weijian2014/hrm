$(document).ready(function () {
  ...
  $(".addBtn").click(function (event) {
    ...
    var partsSellingPrice = Number(
      $('input[name="partsSellingPriceInput"]').val()
    );

    if ("" == vehicleName || "" == partsName || "" == partsNo) {
    ...
    $(ele)
      ...
      .html(
        `<input type="text" value="` +
          oldVal +
          `" style="border: none; background-color: #0BE093; color: inherit; width: 230px; height: 30px; font-size: 20px;"/>`
      )
      .find("input")
      .focus()
      .blur(function () {

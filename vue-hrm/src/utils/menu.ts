...
export const menuAddApi = (data: Menu): PromiseResponse<string> => request.post("/menu/add")

export const menuUpdateApi = (data: Menu): PromiseResponse<string> => request.put("/menu/update", data)
